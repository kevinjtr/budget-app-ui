...
class Project extends React.Component {
  ...
  componentDidMount() {
    const { doProjectFetch,  projectItems, fySelectedItem} = this.props;
  ...
  setProject(row) {
    const { doUpdateUrlWithHomepage, orgsByRoute, fySelectedItem } = this.props;

    doUpdateUrlWithHomepage(`/${orgsByRoute.slug}/${fySelectedItem.year}/project/${row.id}`);
  }
  render() {
    ...
    return (
      ...
      <div>
        ...
        <Typography variant="subtitle2"component="div">Double Click Row to Open Project</Typography>
