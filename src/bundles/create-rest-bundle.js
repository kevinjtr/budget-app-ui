...
const toast_alerts = {
  save: {
    ...
    error: 'Error, data could not be saved',
  },
  delete: {
    loading: 'Deleting',
    success: 'Successfully deleted data',
    error: 'Error, data could not be deleted',
  }
}
 ...
 export default (opts) => {
  ...
  const result = Object.assign(
    {},
    {
      ...
      [doBulkSave]: (item, id, opts, callback, deferCallback) => ({
        dispatch,
        store,
        apiPost,
      }) => {

        const hide_notification = opts?.hide_notification
      ...
      [doSave]: (item, opts, callback, deferCallback) => ({
        dispatch,
        store,
        apiPut,
        apiPost,
      ...
      [doDelete]: (item, opts, callback, deferCallback) => ({
        dispatch,
        store,
        apiDelete,
      }) => {
